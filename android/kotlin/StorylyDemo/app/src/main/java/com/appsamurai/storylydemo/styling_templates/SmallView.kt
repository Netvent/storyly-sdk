...
import com.appsamurai.storylydemo.databinding.StylingSmallBinding
import com.appsamurai.storylydemo.styling_templates.ui.dpToPixel
import com.bumptech.glide.Glide

@SuppressLint("ViewConstructor")
class SmallView(context: Context) : StoryGroupView(context) {

    private val binding: StylingSmallBinding = StylingSmallBinding.inflate(LayoutInflater.from(context))
...
class SmallViewFactory(val context: Context): StoryGroupViewFactory() {
