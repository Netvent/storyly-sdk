...
import com.appsamurai.storylydemo.databinding.StylingPortraitBinding
import com.appsamurai.storylydemo.styling_templates.ui.dpToPixel
import com.bumptech.glide.Glide

@SuppressLint("ViewConstructor")
class PortraitView(context: Context) : StoryGroupView(context) {

    private val listViewBinding: StylingPortraitBinding = StylingPortraitBinding.inflate(LayoutInflater.from(context))
    ...
    override fun populateView(storyGroup: StoryGroup?) {
        ...
        if (storyGroup?.type == StoryGroupType.Vod) {
            ...
            listViewBinding.pinIcon.avatarBackgroundColor = Color.parseColor("#7651FF")
        }
...
class PortraitViewFactory(val context: Context): StoryGroupViewFactory() {
