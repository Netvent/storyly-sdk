...
class VerticalFeed extends Component {
    refresh = () => {
        UIManager.dispatchViewManagerCommand(
            ...
            UIManager.getViewManagerConfig('STVerticalFeed').Commands.refresh,
            [],
        );
    };
    ...
    resumeStory = () => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeed').Commands.resumeStory,
            [],
        );
    };
    ...
    pauseStory = () => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeed').Commands.pauseStory,
            [],
        );
    };
    ...
    closeStory = () => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeed').Commands.closeStory,
            [],
        );
    };
    ...
    openStory = (payload) => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeed').Commands.openStory,
            [payload],
        );
    };
    ...
    openStoryWithId = (storyGroupId, storyId, playMode) => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeed').Commands.openStoryWithId,
    ...
    hydrateProducts = (products) => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeed').Commands.hydrateProducts,
            [products],
        );
    }
    ...
    updateCart = (cart) => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeed').Commands.updateCart,
            [cart],
        );
    }
    ...
    approveCartChange = (responseId, cart) => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeed').Commands.approveCartChange,
            [responseId, cart],
        );
    }
...
const STVerticalFeed = requireNativeComponent('STVerticalFeed', null);
