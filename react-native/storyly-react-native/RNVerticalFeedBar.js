...
class VerticalFeedBar extends Component {
    ...
    hydrateWishlist = (products) => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeedBar').Commands.hydrateWishlist,
            [products],
        );
    }    
    ...
    approveWishlistChange = (responseId, item) => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeedBar').Commands.approveWishlistChange,
            [responseId, item],
        );
    }
    ...
    rejectWishlistChange = (responseId, failMessage) => {
        UIManager.dispatchViewManagerCommand(
            findNodeHandle(this._verticalFeedBarView),
            UIManager.getViewManagerConfig('STVerticalFeedBar').Commands.rejectWishlistChange,
            [responseId, failMessage],
        );
    }
