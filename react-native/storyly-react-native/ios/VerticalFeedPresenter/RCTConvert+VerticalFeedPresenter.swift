...
@objc(VerticalFeedPresenterBundle)
class VerticalFeedPresenterBundle: NSObject {
    let storylyView: StorylyVerticalFeedPresenterView
    
    init(storylyView: StorylyVerticalFeedPresenterView) {
        self.storylyView = storylyView
    }
}

extension RCTConvert {
    @objc(stVerticalFeedPresenterBundle:)
    static func stVerticalFeedPresenterBundle(json: NSDictionary) -> VerticalFeedPresenterBundle? {
        ...
        return VerticalFeedPresenterBundle(storylyView: storylyView)
    }
}
