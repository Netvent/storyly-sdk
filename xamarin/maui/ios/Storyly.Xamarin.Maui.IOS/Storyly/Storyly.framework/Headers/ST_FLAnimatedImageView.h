...
@class ST_FLAnimatedImage;
@protocol ST_FLAnimatedImageViewDebugDelegate;
...
//
@interface ST_FLAnimatedImageView : UIImageView
...
@property (nonatomic, strong) ST_FLAnimatedImage *animatedImage;
