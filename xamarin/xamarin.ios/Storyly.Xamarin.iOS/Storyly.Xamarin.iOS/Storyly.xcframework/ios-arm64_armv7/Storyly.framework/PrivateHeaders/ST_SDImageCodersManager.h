...
/**
 ...
 Coders
 ------
 A coder must conform to the `ST_SDImageCoder` protocol or even to `ST_SDProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface ST_SDImageCodersManager : NSObject <ST_SDImageCoder>
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<ST_SDImageCoder>> *coders;
...
/**
 ...
 @param coder coder
 */
- (void)addCoder:(nonnull id<ST_SDImageCoder>)coder;
...
/**
 ...
 @param coder coder
 */
- (void)removeCoder:(nonnull id<ST_SDImageCoder>)coder;
