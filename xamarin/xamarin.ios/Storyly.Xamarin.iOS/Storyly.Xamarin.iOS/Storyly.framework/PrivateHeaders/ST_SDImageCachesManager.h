 ...
 */
@interface ST_SDImageCachesManager : NSObject <ST_SDImageCache>

/**
 Returns the global shared caches manager instance. By default we will set [`ST_SDImageCache.sharedImageCache`] into the caches array.
 */
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<ST_SDImageCache>> *caches;
...
/**
 ...
 @param cache cache
 */
- (void)addCache:(nonnull id<ST_SDImageCache>)cache;
...
/**
 ...
 @param cache cache
 */
- (void)removeCache:(nonnull id<ST_SDImageCache>)cache;
