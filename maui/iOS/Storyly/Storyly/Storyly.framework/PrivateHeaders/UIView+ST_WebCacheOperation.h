 ...
 */
@interface UIView (ST_WebCacheOperation)
 ...
 */
- (nullable id<ST_SDWebImageOperation>)st_imageLoadOperationForKey:(nullable NSString *)key;
 ...
 */
- (void)st_setImageLoadOperation:(nullable id<ST_SDWebImageOperation>)operation forKey:(nullable NSString *)key;
 ...
 *  @param key key for identifying the operations
 */
- (void)st_cancelImageLoadOperationWithKey:(nullable NSString *)key;
 ...
 *  @param key key for identifying the operations
 */
- (void)st_removeImageLoadOperationWithKey:(nullable NSString *)key;
