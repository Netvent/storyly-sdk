...
typedef NS_OPTIONS(NSUInteger, SDWebImageDownloaderOptions) {
     ...
     * And the error code is `ST_SDWebImageErrorCacheNotModified`
     ...
     * Using this option, can ensure we always produce image with your provided class. If failed, a error with code `ST_SDWebImageErrorBadImageData` will been used.
...
typedef ST_SDImageLoaderProgressBlock SDWebImageDownloaderProgressBlock;
typedef ST_SDImageLoaderCompletedBlock SDWebImageDownloaderCompletedBlock;

/**
 *  A token associated with each download. Can be used to cancel a download
 */
@interface ST_SDWebImageDownloadToken : NSObject <ST_SDWebImageOperation>
 ...
 * @note If you want to modify single request, consider using `ST_SDWebImageContextDownloadRequestModifier` context option.
 */
 ...
 * @note If you want to modify single response, consider using `ST_SDWebImageContextDownloadResponseModifier` context option.
 */
 ...
 * @note If you want to decrypt single download data, consider using `ST_SDWebImageContextDownloadDecryptor` context option.
 */
...
/**
 SDWebImageDownloader is the built-in image loader conform to `ST_SDImageLoader`. Which provide the HTTP/HTTPS/FTP download, or local file URL using NSURLSession.
 ...
 If you want to provide some image loader which beyond network or local file, consider to create your own custom class conform to `ST_SDImageLoader`.
 */
@interface ST_SDWebImageDownloader (ST_SDImageLoader) <ST_SDImageLoader>
