 ...
 */
FOUNDATION_EXPORT NSString * _Nullable ST_SDTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
...
/**
 ...
 @note If you have both transformer and thumbnail applied for image, call `ST_SDThumbnailedKeyForKey` firstly and then with `ST_SDTransformedKeyForKey`.`
 */
FOUNDATION_EXPORT NSString * _Nullable ST_SDThumbnailedKeyForKey(NSString * _Nullable key, CGSize thumbnailPixelSize, BOOL preserveAspectRatio);

/**
 A transformer protocol to transform the image load from cache or from download.
 You can provide transformer to cache and manager (Through the `transformer` property or context option `ST_SDWebImageContextImageTransformer`).
 ...
 */
@property (nonatomic, assign, readonly) ST_SDRectCorner corners;
...
- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithRadius:(CGFloat)cornerRadius corners:(ST_SDRectCorner)corners borderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor;
 ...
 */
@property (nonatomic, assign, readonly) ST_SDImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(ST_SDImageScaleMode)scaleMode;
