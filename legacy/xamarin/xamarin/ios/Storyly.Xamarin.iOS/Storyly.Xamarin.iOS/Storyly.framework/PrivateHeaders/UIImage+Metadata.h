 ...
 * If you don't manually specify a format, this information is retrieve from CGImage using `CGImageGetUTType`, which may return nil for non-CG based image. At this time it will return `ST_SDImageFormatUndefined` as default value.
 ...
 */
@property (nonatomic, assign) ST_SDImageFormat sd_imageFormat;
