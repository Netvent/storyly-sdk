 ...
 */
@interface ST_SDImageIOAnimatedCoder : NSObject <ST_SDProgressiveImageCoder, ST_SDAnimatedImageCoder>

#pragma mark - Subclass Override
/**
 The supported animated image format. Such as `ST_SDImageFormatGIF`.
 @note Subclass override.
 */
@property (class, readonly) ST_SDImageFormat imageFormat;
/**
 The supported image format UTI Type. Such as `kSDUTTypeGIF`.
 This can be used for cases when we can not detect `ST_SDImageFormat. Such as progressive decoding's hint format `kCGImageSourceTypeIdentifierHint`.
 @note Subclass override.
 */
