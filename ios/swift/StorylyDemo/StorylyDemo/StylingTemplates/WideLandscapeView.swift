...
public class WideLandscapeView: StoryGroupView {
    
    let kCONTENT_XIB_NAME = "WideLandscapeView"
...
public class WideLandscapeViewFactory: StoryGroupViewFactory {
    public func getSize() -> CGSize {
        return CGSize(width: 178, height: 100)
    }
    
    public func createView() -> StoryGroupView {
        return WideLandscapeView(frame: .zero)
    }
}
