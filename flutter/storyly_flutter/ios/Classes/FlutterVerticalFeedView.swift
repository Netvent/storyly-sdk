...
public class FlutterVerticalFeedViewFactory: NSObject, FlutterPlatformViewFactory {
    private let messenger: FlutterBinaryMessenger
    private var viewList: [Int64: Weak<FlutterVerticalFeedView>] = [:]
    ...
    public func create(withFrame frame: CGRect, viewIdentifier viewId: Int64, arguments args: Any?) -> FlutterPlatformView {
        let flutterStorylyView =  FlutterVerticalFeedView(frame, viewId: viewId, args: args as? [String : Any] ?? [:], messenger: self.messenger)
        self.viewList[viewId] = Weak<FlutterVerticalFeedView>(value: flutterStorylyView)
    ...
    public func getViewById(id: Int) -> StorylyVerticalFeedView? {
...
public class FlutterVerticalFeedView: NSObject, FlutterPlatformView {
    ...
    private lazy var storylyViewWrapper = FlutterVerticalFeedViewWrapper(frame: self.frame, args: self.args, methodChannel: self.methodChannel)
    
    init(_ frame: CGRect, viewId: Int64, args: [String: Any], messenger: FlutterBinaryMessenger) {
        self.frame = frame
        self.viewId = viewId
        self.args = args
        self.methodChannel = FlutterMethodChannel(name: "com.appsamurai.storyly/flutter_vertical_feed_\(viewId)", binaryMessenger: messenger)
    }
    
    public func getStorylyView() -> StorylyVerticalFeedView {
...
internal class FlutterVerticalFeedViewWrapper: UIView {
    internal let verticalFeedView: StorylyVerticalFeedView
    ...
    init(frame: CGRect,
        ...
        self.verticalFeedView = StorylyVerticalFeedView(frame: frame)
...
extension FlutterVerticalFeedViewWrapper: StorylyVerticalFeedProductDelegate {
...
extension FlutterVerticalFeedViewWrapper: StorylyVerticalFeedDelegate {
