...
class StorylyMonetization {
  ...
  static const MethodChannel _methodChannel = MethodChannel('com.appsamurai.storyly.storyly_monetization_flutter/storyly_monetization_flutter');

  /// This function allows you to set `AdViewProvider` for `StorylyView` with view id
  static Future<void> setAdViewProvider(int viewId, AdViewProvider? adViewProvider) {
